 ...
 * @author sibmaks
 */
public class IronTrashCanBlock extends TrashCanBlock {
    public IronTrashCanBlock(@NotNull Settings settings, int ticksRemove) {
    ...
    public BlockEntity createBlockEntity(@NotNull BlockPos pos,
        ...
        return new IronTrashCanBlockEntity(this, pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world,
        ...
        return world.isClient ? null : TrashCanBlock.checkType(type, Entities.IRON_TRASH_CAN,
