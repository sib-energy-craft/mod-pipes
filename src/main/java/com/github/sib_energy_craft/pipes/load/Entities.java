...
public final class Entities implements DefaultModInitializer {
    ...
    public static final BlockEntityType<BronzePipeBlockEntity> BRONZE_PIPE;
    ...
    static {
        ...
        BRONZE_PIPE = EntityUtils.register(Blocks.BRONZE_PIPE,
                (pos, state) -> new BronzePipeBlockEntity(Blocks.BRONZE_PIPE.entity(), pos, state));
