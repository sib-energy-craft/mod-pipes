...
import com.github.sib_energy_craft.pipes.block.entity.BronzePipeBlockEntity;
 ...
 * @author sibmaks
 */
public class BronzePipeBlock extends PipeBlock {
    public BronzePipeBlock(@NotNull Settings settings, int ticksToInsert) {
    ...
    public BlockEntity createBlockEntity(@NotNull BlockPos pos,
        ...
        return new BronzePipeBlockEntity(this, pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world,
        ...
        return world.isClient ? null : PipeBlock.checkType(type, Entities.BRONZE_PIPE, PipeBlockEntity::serverTick);
    }
}
