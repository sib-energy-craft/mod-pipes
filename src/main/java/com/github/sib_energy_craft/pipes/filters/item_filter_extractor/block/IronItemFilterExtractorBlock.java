 ...
 * @author sibmaks
 */
public class IronItemFilterExtractorBlock extends ItemFilterExtractorBlock {
    public IronItemFilterExtractorBlock(@NotNull Settings settings, int ticksToExtract, int ticksToInsert) {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world,
        ...
        return world.isClient ? null : ItemFilterExtractorBlock.checkType(type, Entities.IRON_ITEM_FILTER_EXTRACTOR,
