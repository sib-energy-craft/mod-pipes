 ...
 * @author sibmaks
 */
public class BronzePipeItemFilterBlock extends PipeItemFilterBlock {
    public BronzePipeItemFilterBlock(@NotNull Settings settings, int ticksToInsert) {
    ...
    public BlockEntity createBlockEntity(@NotNull BlockPos pos,
        ...
        return new BronzePipeItemFilterBlockEntity(this, pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world,
        ...
        return world.isClient ? null : PipeItemFilterBlock.checkType(type, Entities.BRONZE_PIPE_ITEM_FILTER,
