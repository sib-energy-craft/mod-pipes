 ...
 * @author sibmaks
 */
public class DiamondItemFilterExtractorBlock extends ItemFilterExtractorBlock {
    public DiamondItemFilterExtractorBlock(@NotNull Settings settings, int ticksToExtract, int ticksToInsert) {
    ...
    public BlockEntity createBlockEntity(@NotNull BlockPos pos,
        ...
        return new DiamondItemFilterExtractorBlockEntity(this, pos, state);
    }
