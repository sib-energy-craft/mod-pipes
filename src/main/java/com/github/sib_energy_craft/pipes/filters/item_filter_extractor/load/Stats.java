...
public final class Stats implements DefaultModInitializer {
    public static final Identifier INTERACT_ITEM_FILTER_EXTRACTOR;

    static {
        INTERACT_ITEM_FILTER_EXTRACTOR = register(Identifiers.asString("interact_with_item_filter_extractor"), StatFormatter.DEFAULT);
    }
