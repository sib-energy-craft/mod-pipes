 ...
 * @author sibmaks
 */
public class PipeItemFilterItemScreen extends HandledScreen<PipeItemFilterItemScreenHandler> {
    private static final Identifier TEXTURE = Identifiers.of("textures/gui/container/pipe_item_filter.png");

    public PipeItemFilterItemScreen(@NotNull PipeItemFilterItemScreenHandler handler,
